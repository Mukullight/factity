...
export function Fragment_e3d40fcfc84eca2e72bf845ac816abd9 () {
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["width"] : "100%", ["height"] : "100%" })} direction={"column"} id={"my-child"} ref={ref_my_child} gap={"3"}>

<RadixThemesBox css={({ ["width"] : "100%", ["textAlign"] : "center", ["py"] : "10", ["padding"] : "0.25em" })}>

<RadixThemesHeading align={"center"} css={({ ["mb"] : "4", ["padding"] : "0.5em" })} size={"9"}>

{"About Our Company"}
</RadixThemesHeading>
<RadixThemesSeparator color={"tomato"} css={({ ["padding"] : "0.25em" })} size={"4"}/>
<RadixThemesHeading css={({ ["variant"] : "solid", ["textColor"] : "white", ["paddingTop"] : "0.25em", ["paddingBottom"] : "1em" })} size={"8"}>

{"A place for clarity \ud83d\ude0a or is it ? \ud83e\udd28 "}
</RadixThemesHeading>
</RadixThemesBox>
<RadixThemesFlex align={"center"} className={"rx-Stack"} css={({ ["maxWidth"] : "1200px", ["margin"] : "0 auto", ["p"] : "4" })} direction={"column"} gap={"1"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"row"} gap={"3"}>

<RadixThemesBox css={({ ["p"] : "6", ["flex"] : "1" })}>
...
<RadixThemesSeparator color={"tomato"} css={({ ["padding"] : "1em" })} size={"4"}/>
<RadixThemesBox css={({ ["textAlign"] : "center", ["py"] : "10", ["align"] : "center" })}>

<RadixThemesFlex align={"center"} className={"rx-Stack"} direction={"column"} gap={"3"}>

<RadixThemesHeading css={({ ["mb"] : "6" })} size={"9"}>

{"Our Team"}
</RadixThemesHeading>
<img align={"center"} css={({ ["name"] : "Mukul Namagiri", ["width"] : "40%", ["height"] : "40%" })} src={"/fucku.png"}/>
<RadixThemesFlex align={"center"} className={"rx-Stack"} css={({ ["paddingTop"] : "1em" })} direction={"column"} gap={"8"}>

<RadixThemesBox css={({ ["p"] : "4", ["align"] : "centre" })}>
...
<RadixThemesHeading css={({ ["mb"] : "4" })} size={"9"}>
...
export function Errorboundary_ffec3c75214f901a55e877563e5806e5 () {
...
<Fragment_e3d40fcfc84eca2e72bf845ac816abd9/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_ffec3c75214f901a55e877563e5806e5/>
  )
}
