...
export function Fragment_a6aa30f0aba9d1a061b48251cfacd20b () {
  ...
  const reflex___state____state__reflex_local_auth___local_auth____local_auth_state__factity___auth___state____session_state__factity___contact___state____contact_state = useContext(StateContexts.reflex___state____state__reflex_local_auth___local_auth____local_auth_state__factity___auth___state____session_state__factity___contact___state____contact_state)
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_d0fb3fd0f1bc3c8cc41e7ce9cc3ac63a = useCallback((ev) => {
        const $form = ev.target
        ev.preventDefault()
        const form_data = {...Object.fromEntries(new FormData($form).entries()), ...({  })};

        (((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.factity___auth___state____session_state.factity___contact___state____contact_state.handle_submit", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
{(reflex___state____state__reflex_local_auth___local_auth____local_auth_state__factity___auth___state____session_state__factity___contact___state____contact_state.did_submit ? reflex___state____state__reflex_local_auth___local_auth____local_auth_state__factity___auth___state____session_state__factity___contact___state____contact_state.thank_you : "")}
<RadixThemesBox css={({ ["@media screen and (min-width: 0)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 30em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 48em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 62em)"] : ({ ["display"] : "block" }) })}>

<RadixThemesBox css={({ ["width"] : "50vw" })}>

<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_d0fb3fd0f1bc3c8cc41e7ce9cc3ac63a}>
...
export function Errorboundary_ddf91ec2c3d45f1f086569d080661ee0 () {
...
<Fragment_a6aa30f0aba9d1a061b48251cfacd20b/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_ddf91ec2c3d45f1f086569d080661ee0/>
  )
}
