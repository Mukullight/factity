...
export function Fragment_048f3220b9e75f434434816510a5825a () {
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["trigger"] : (jsx(RadixThemesButton, ({  }), (jsx(LucidePlusIcon, ({ ["css"] : ({ ["color"] : "var(--current-color)" }), ["size"] : 26 }))), (jsx(RadixThemesText, ({ ["as"] : "p", ["size"] : "4" }), (jsx(Fragment, ({  }), "Upload Audio")))))) })} direction={"column"} gap={"3"}>
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["background"] : "center/cover url('/background.jpg')", ["width"] : "100%", ["height"] : "100%" })} direction={"column"} gap={"3"}>

<RadixThemesBox css={({ ["@media screen and (min-width: 0)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 30em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 48em)"] : ({ ["display"] : "none" }), ["@media screen and (min-width: 62em)"] : ({ ["display"] : "block" }) })}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["padding"] : "2em" })} direction={"row"} gap={"3"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"row"} gap={"3"}>

<img align={"right"} css={({ ["width"] : "90%", ["height"] : "90%", ["borderRadius"] : "15%", ["borderColor"] : "white", ["padding"] : "5em" })} src={"/Fact-ity.png"}/>
<RadixThemesBox>

<RadixThemesText as={"p"} css={({ ["padding"] : "4em", ["paddingRight"] : "3em", ["color"] : ((resolvedColorMode === "light") ? "white" : "white") })} size={"8"} weight={"bold"}>

{"FACT-ITY an open source tool that allows content creators to leverage the power of AI agents to check for the factual correctness helping reduce the time in post production"}
</RadixThemesText>
</RadixThemesBox>
</RadixThemesFlex>
</RadixThemesFlex>
...
<RadixThemesText as={"p"} css={({ ["padding"] : "4em", ["paddingTop"] : "0em", ["paddingBottom"] : "1em", ["color"] : ((resolvedColorMode === "light") ? "tomato" : "tomato"), ["textAlign"] : "center" })} size={"9"} weight={"bold"}>

{"Stressed about the content you generate"}
</RadixThemesText>
</RadixThemesBox>
<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"row"} gap={"3"}>

<img align={"right"} css={({ ["width"] : "40%", ["height"] : "40%", ["borderRadius"] : "15%", ["borderColor"] : "white", ["padding"] : "5em" })} src={"/stressed_person.png"}/>
<RadixThemesText as={"p"} css={({ ["padding"] : "4em", ["paddingRight"] : "3em", ["color"] : ((resolvedColorMode === "light") ? "white" : "white") })} size={"8"} weight={"bold"}>

{"Feeling stressed about the accuracy of your content? Don't worry\u2014FACT-ITY is here to assist you. FACT-ITY empowers you to verify the facts within your content, ensuring accuracy and helping you to correct any errors that might be present."}
</RadixThemesText>
</RadixThemesFlex>
</RadixThemesFlex>
</RadixThemesFlex>
...
<RadixThemesText as={"p"} css={({ ["color"] : ((resolvedColorMode === "light") ? "tomato" : "tomato"), ["textAlign"] : "center" })} size={"9"} weight={"bold"}>
...
<img align={"right"} css={({ ["width"] : "40%", ["height"] : "40%", ["borderRadius"] : "15%", ["borderColor"] : "white", ["padding"] : "3em" })} src={"/dude_checking.png"}/>
<img align={"right"} css={({ ["width"] : "40%", ["height"] : "40%", ["borderRadius"] : "15%", ["borderColor"] : "white", ["padding"] : "3em" })} src={"/dude_happy.png"}/>
</RadixThemesFlex>
</RadixThemesFlex>
<RadixThemesSeparator size={"4"}/>
</RadixThemesBox>
...
<img align={"right"} css={({ ["width"] : "90%", ["height"] : "90%", ["borderRadius"] : "15%", ["borderColor"] : "white", ["padding"] : "3em" })} src={"/Fact-ity.png"}/>
<RadixThemesBox>
...
<img align={"right"} css={({ ["width"] : "60%", ["height"] : "60%", ["borderRadius"] : "15%", ["borderColor"] : "white", ["padding"] : "2em" })} src={"/stressed_person.png"}/>
<RadixThemesText as={"p"} css={({ ["padding"] : "4em", ["paddingRight"] : "3em", ["color"] : ((resolvedColorMode === "light") ? "white" : "white") })} size={"6"} weight={"bold"}>
...
<RadixThemesFlex align={"start"} className={"rx-Stack"} css={({ ["paddingTop"] : "0em" })} direction={"column"} gap={"3"}>

<RadixThemesFlex align={"start"} className={"rx-Stack"} direction={"column"} gap={"3"}>

<img align={"center"} css={({ ["width"] : "30%", ["height"] : "30%" })} src={"/Fact-ity.png"}/>
<RadixThemesText as={"p"} css={({ ["padding"] : "2em", ["color"] : ((resolvedColorMode === "light") ? "white" : "white") })} size={"6"} weight={"bold"}>
...
export function Errorboundary_b0de2cbf93256487bd7787a45222e9fa () {
...
<Fragment_048f3220b9e75f434434816510a5825a/>
<NextHead>
...
export default function Component() {
  ...
  return (
    <Errorboundary_b0de2cbf93256487bd7787a45222e9fa/>
  )
}
