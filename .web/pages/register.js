...
export function Errorboundary_2a6a4bb717100be18ade6b7e9ba06c16 () {
...
<Fragment_e916624662284c15ce4460b8153d620d/>
<NextHead>
...
export function Fragment_e916624662284c15ce4460b8153d620d () {
  ...
  const ref_my_navbar_hstack_desktop = useRef(null); refs["ref_my_navbar_hstack_desktop"] = ref_my_navbar_hstack_desktop;
    ...
    const handleSubmit_379ebe038d86e5baa254b640713127bd = useCallback((ev) => {
        ...
        (((...args) => (addEvents([(Event("reflex___state____state.reflex_local_auth___local_auth____local_auth_state.reflex_local_auth___registration____registration_state.factity___auth___state____my_register_state.handle_registration_email", ({ ["form_data"] : form_data }), ({  })))], args, ({  }))))());
...
<RadixFormRoot className={"Root "} css={({ ["width"] : "100%" })} onSubmit={handleSubmit_379ebe038d86e5baa254b640713127bd}>
...
export default function Component() {
  ...
  return (
    <Errorboundary_2a6a4bb717100be18ade6b7e9ba06c16/>
  )
}
